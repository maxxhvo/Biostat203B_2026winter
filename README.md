...
Brief instructions for reproducing the course materials are given below. For more detailed instructions, see [lab 1](https://ucla-biostat-203b.github.io/2026winter/labs/lab01/lab01.html).
...
3. (Optional) Install the Python packages required for the course. More often than not, you have multiple versions of Python installed on your machine. Make sure you install the packages for the Python version that you use for this course. In RStudio, choose the Python version at `Tools` -> `Global Options` -> `Python`. 
...
4. (Optional) Install the Julia packages required for the course. 
...
2. Pull the Docker image from Docker Hub.
    ...
    ```bash
    docker pull huazhou/ucla-biostat-203b-2026w
    ```

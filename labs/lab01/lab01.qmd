...
Adventurous ones are encouraged to try out [Positron](https://posit.co/download/positron/), which is a free and open-source IDE for R and Python developed by Posit (formerly RStudio). It has built-in support for Quarto and Git. The user interface is similar to RStudio Desktop.
:::

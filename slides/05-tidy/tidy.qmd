...
- An example file [heights.csv](https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/master/slides/05-tidy/heights.csv):
```{bash}
head heights.csv
```
...
- Read from a local file [heights.csv](https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/master/slides/05-tidy/heights.csv):
```{r}
...
- Read from a url:
```{r}
heights <- read_csv("https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/master/slides/05-tidy/heights.csv") |>
  print(width = Inf)
```
...
url = "https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/master/slides/05-tidy/heights.csv"
...
http_response = HTTP.get("https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/master/slides/05-tidy/heights.csv");

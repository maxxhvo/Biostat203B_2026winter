...
Scenario 7: You work on a research project that uses the cutting-edge [NIH All of US](https://allofus.nih.gov/) or [pheno.ai](https://www.pheno.ai/) data. The data resides in the cloud (GCP or AWS) and the computational environment does not have the software tools you need 🙁

<p align="center">
![](./nih-all-of-us-docker.png){width=600px}
</p>

<p align="center">
![](./pheno-ai-docker.png){width=600px}
</p>
...
- [`requirements.txt`](https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/refs/heads/main/slides/19-docker/requirements.txt) lists the Python dependencies:
```{bash, eval=TRUE}
cat requirements.txt
```
Flask is Python tool for web development. Redis is a in-memory database system.

- [`app.py`](https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/refs/heads/main/slides/19-docker/app.py) is the Python code for serving a webpage.
```{bash}
#| eval: false
cat app.py
```

- [`Dockerfile`](https://raw.githubusercontent.com/ucla-biostat-203b/2025winter/refs/heads/main/slides/19-docker/Dockerfile) instructs Docker how to put things together in a container:
```{bash}
#| eval: false
cat Dockerfile
```
